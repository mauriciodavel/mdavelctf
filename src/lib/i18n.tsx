...
const translations: TranslationDict = {
  ...
  'dash.total_leagues': { 'pt-BR': 'Total de Ligas', 'en': 'Total Leagues' },
  'dash.league_events': { 'pt-BR': 'Eventos em Ligas', 'en': 'Events in Leagues' },
  ...
  'league.total_events': { 'pt-BR': 'Eventos Vinculados', 'en': 'Linked Events' },
  'league.total_challenges': { 'pt-BR': 'Total de Desafios', 'en': 'Total Challenges' },
  'league.total_flags': { 'pt-BR': 'Total de Flags', 'en': 'Total Flags' },
  'league.remaining_time': { 'pt-BR': 'Tempo Restante', 'en': 'Remaining Time' },
  'league.start_date': { 'pt-BR': 'Início', 'en': 'Start' },
  'league.end_date': { 'pt-BR': 'Fim', 'en': 'End' },
  'league.events': { 'pt-BR': 'Eventos da Liga', 'en': 'League Events' },
  'league.no_events': { 'pt-BR': 'Nenhum evento vinculado', 'en': 'No linked events' },
  'league.hours': { 'pt-BR': 'horas', 'en': 'hours' },
  'league.finished': { 'pt-BR': 'Encerrada', 'en': 'Finished' },
  'league.active': { 'pt-BR': 'Ativa', 'en': 'Active' },
  'league.scheduled': { 'pt-BR': 'Agendada', 'en': 'Scheduled' },
  'league.missions': { 'pt-BR': 'missões', 'en': 'missions' },
  'league.challenges': { 'pt-BR': 'desafios', 'en': 'challenges' },
